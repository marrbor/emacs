...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dart-mode typescript-mode auto-install ac-php php-auto-yasnippets php-mode smooth-scroll groovy-mode markdown-mode flycheck yaml-mode w3m plantuml-mode magit json-mode golint go-eldoc go-dlv go-autocomplete ddskk company-go)))
 '(show-paren-mode t))
(custom-set-faces
